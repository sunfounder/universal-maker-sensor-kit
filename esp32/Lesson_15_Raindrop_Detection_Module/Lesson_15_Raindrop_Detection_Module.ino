/*
  This code reads the digital value from a raindrops detection sensor 
  module connected to pin 25 and prints it to the serial monitor every 
  50 milliseconds. When the rainwater on the sensor reaches the threshold, 

...
.. |link_micropython_pi| raw:: html
    ...
    <a href="https://www.raspberrypi.com/documentation/microcontrollers/micropython.html#drag-and-drop-micropython" target="_blank">methode</a>
...
.. |link_micropython_onewire_driver| raw:: html
    ...
    <a href="https://docs.micropython.org/en/latest/rp2/quickref.html#onewire-driver" target="_blank">OneWire-Treiber</a>
...
.. |link_buy_pi_case| raw:: html
    ...
    <a href="https://www.sunfounder.com/search?type=product&q=CASE" target="_blank">hier</a>

.. |link_set_up_pi| raw:: html

    <a href="https://projects.raspberrypi.org/en/projects/raspberry-pi-setting-up" target="_blank">Einrichten Raspberry Pi</a>
...
.. |link_python_on_raspberry_pi| raw:: html
    ...
    <a href="https://www.raspberrypi.com/documentation/computers/os.html#python-on-raspberry-pi" target="_blank">Python auf dem Raspberry Pi - Raspberry Pi Dokumentation</a>
...
.. |link_Universal_Maker_Sensor_Kit| raw:: html
    ...
    <a href="https://www.sunfounder.com/products/sunfounder-universal-maker-sensor-kit?_pos=1&_sid=0cf649641&_ss=r" target="_blank">Kauflink für Universal Maker Sensor Kit</a>
...
.. |link_rpi5_buy| raw:: html
    ...
    <a href="https://www.sunfounder.com/collections/the-raspberry-pi/products/raspberry-pi-5" target="_blank">KAUFEN</a>
...
.. |link_servo_buy| raw:: html
    ...
    <a href="https://www.sunfounder.com/products/sf0180-servo-motor" target="_blank">KAUFEN</a>
...
.. |link_pir_buy| raw:: html
    ...
    <a href="https://www.sunfounder.com/products/hcsr501-infrared-sensor" target="_blank">KAUFEN</a>
...
.. |link_dht11_humiture_buy| raw:: html
    ...
    <a href="https://www.sunfounder.com/products/dht11-temperature-and-humidity-sensor-module" target="_blank">KAUFEN</a>

.. |link_obstacle_avoidance_module_buy| raw:: html

    <a href="https://www.sunfounder.com/products/ir-obstacle-avoidance-sensor-module" target="_blank">KAUFEN</a>
...
.. |link_soil_moisture_buy| raw:: html
    ...
    <a href="https://www.sunfounder.com/products/capacitive-soil-moisture-sensor-module" target="_blank">KAUFEN</a>       
...
.. |link_flame_sensor_module_buy| raw:: html
    ...
    <a href="https://www.sunfounder.com/products/flame-sensor-module-1" target="_blank">KAUFEN</a>

.. |link_mq2_gas_sensor_module_buy| raw:: html

    <a href="https://www.sunfounder.com/products/mq-2-gas-sensor-module" target="_blank">KAUFEN</a>

.. |link_speed_sensor_module_buy| raw:: html

    <a href="https://www.sunfounder.com/products/h2010-speed-ir-measuring-sensor-module" target="_blank">KAUFEN</a>

.. |link_pcf8591_module_buy| raw:: html

    <a href="https://www.sunfounder.com/products/pcf8591-converter-module" target="_blank">KAUFEN</a>


.. |link_photoresistor_sensor_module_buy| raw:: html

    <a href="https://www.sunfounder.com/products/photoresistor-sensor-module-1" target="_blank">KAUFEN</a>

.. |link_potentiometer_sensor_module_buy| raw:: html

    <a href="https://www.sunfounder.com/products/potentiometer-sensor-module" target="_blank">KAUFEN</a>

.. |link_max30102_module_buy| raw:: html

    <a href="https://www.sunfounder.com/products/max30102-heart-rate-sensor-module-pulse-detection-blood-oxygen-concentration-module" target="_blank">KAUFEN</a>

.. |link_raindrop_sensor_module_buy| raw:: html

    <a href="https://www.sunfounder.com/products/raindrop-detection-sensor-module" target="_blank">KAUFEN</a>

.. |link_ds1302_module_buy| raw:: html

    <a href="https://www.sunfounder.com/products/ds1302-rtc-real-time-clock-module" target="_blank">KAUFEN</a>

.. |link_bmp280_module_buy| raw:: html

    <a href="https://www.sunfounder.com/products/bmp280-high-precision-digital-atmospheric-barometric-pressure-module" target="_blank">KAUFEN</a>

.. |link_vl53l0x_module_buy| raw:: html

    <a href="https://www.sunfounder.com/products/vl53l0x-time-of-flight-distance-sensor-laser-ranging-module" target="_blank">KAUFEN</a>

.. |link_sw420_vibration_module_buy| raw:: html

    <a href="https://www.sunfounder.com/products/sw-420-vibration-switch-sensor-module" target="_blank">KAUFEN</a>

.. |link_traffic_light_module_buy| raw:: html

    <a href="https://www.sunfounder.com/products/mini-traffic-light-led-5v-8mm-module" target="_blank">KAUFEN</a>

.. |link_passive_buzzer_module_buy| raw:: html

    <a href="https://www.sunfounder.com/products/3-3-5v-passive-low-level-trigger-buzzer-alarm-sound-module" target="_blank">KAUFEN</a>

.. |link_jdy31_bluetooth_module_buy| raw:: html

    <a href="https://www.sunfounder.com/products/jdy-31-bluetooth-wireless-communication-serial-pass-through-module-replace-hc-05-hc-06" target="_blank">KAUFEN</a>
